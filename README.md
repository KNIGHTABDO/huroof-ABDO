...
- 📱 **تجربة غامرة (PWA & Fullscreen):** إمكانية تثبيت اللعبة على الشاشة الرئيسية (Add to Home Screen) للعب في وضع الشاشة الكاملة وبدون شريط المتصفح.
- 📲 **انضمام سريع عبر QR Code:** مسح الكود من جهاز المضيف للانضمام الفوري للغرفة.
