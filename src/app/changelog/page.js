  ...
  return (
    ...
    >
      <div className="changelog-item">
        <span className="info-date">26 مارس 2026</span>
        <h3>
          <span className="changelog-version">v2.3.0</span>
          إدارة الأسئلة المحفوظة (Manage Saved Questions)
        </h3>
        <ul>
          <li><strong>جديد:</strong> صفحة متكاملة جديدة <strong>إدارة الأسئلة المحفوظة</strong> عبر المسار <code>/saved-questions</code>، لعرض وإدارة بيانات نظام منع التكرار مباشرةً من التطبيق.</li>
          <li><strong>جديد:</strong> عرض الأسئلة مجمّعةً بالحرف (قابلة للطي) أو كقائمة مسطّحة مع بحث فوري في نص السؤال والجواب والحرف.</li>
          <li><strong>جديد:</strong> زر &quot;إعادة تفعيل&quot; لإزالة أي سؤال من قائمة المحفوظة لكي يُطرح مجدداً.</li>
          <li><strong>جديد:</strong> تحديد متعدد وحذف جماعي، إضافةً لمسح بيانات حرف واحد أو مسح الكل — مع تأكيد مزدوج.</li>
          <li><strong>جديد:</strong> تصدير كل بيانات منع التكرار بصيغة JSON واستيراد ملف لدمج البيانات بأمان.</li>
          <li><strong>جديد:</strong> شريط إحصائيات يعرض إجمالي الأسئلة المحفوظة، عدد الحروف النشطة، والحروف المكتملة.</li>
          <li><strong>تحسين:</strong> إضافة بطاقة ترويجية ورابط في الصفحة الرئيسية للوصول السريع للصفحة الجديدة.</li>
          <li><strong>خصوصية:</strong> كل البيانات محلية في المتصفح فقط تحت مفاتيح <code>seen_q_*</code> — لا شيء يُرسل لأي خادم.</li>
        </ul>
      </div>
